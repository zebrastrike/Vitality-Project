    ...
    <div className="fixed top-0 left-0 right-0 z-[60] bg-brand-500/10 border-b border-brand-500/20 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-xs text-gray-900/60">
          ...
          <span>
            <strong className="text-gray-900/80">Research Use Only.</strong> All products are strictly for laboratory and research purposes. Not for human consumption. Not evaluated or approved by the FDA.
          </span>
        </div>
        <button onClick={dismiss} className="text-gray-900/30 hover:text-gray-900 transition-colors shrink-0 p-1">
